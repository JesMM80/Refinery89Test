...
@section('titulo')
    Assign a subdepartment to the department   
@endsection
...
@section('contenido')
    ...
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 lg:w-full p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            ...
            @endif
            <form action="{{ route('departments.assignDepartmentStore',$department) }}" method="POST">
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-5 grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="subdepartment" class="border p-3 w-full rounded-lg">
                            <option>-- Select --</option>
                            @forelse ($departments as $subdepartment)
